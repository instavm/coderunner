...
# Configuration
JUPYTER_PORT=${CODERUNNER_JUPYTER_PORT:-8888}
JUPYTER_HOST=${CODERUNNER_JUPYTER_HOST:-0.0.0.0}
MAX_WAIT=${CODERUNNER_MAX_WAIT_JUPYTER:-30}
SHARED_DIR=${CODERUNNER_SHARED_DIR:-/app/uploads}
FASTMCP_PORT=${CODERUNNER_FASTMCP_PORT:-8222}
FASTMCP_HOST=${CODERUNNER_FASTMCP_HOST:-0.0.0.0}
